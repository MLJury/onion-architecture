...
IF EXISTS(SELECT 1 FROM sys.procedures WHERE [object_id] = OBJECT_ID('req.spGetExemptionRequest'))
	DROP PROCEDURE req.spGetExemptionRequest
GO

CREATE PROCEDURE req.spGetExemptionRequest
...
BEGIN
	...
	FROM req._ExemptionRequest exr
